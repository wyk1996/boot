...
void ERTC_TimeRegulate(void)
{
  ...
  ERTC_DateStructure.ERTC_Month = 0x7;
  ERTC_DateStructure.ERTC_Year  = 0x22;
...
uint8_t DATAHEXtoBCD(uint8_t value)
{
    uint8_t  value_bcd;
...
void set_date(uint32_t ERTC_Year,uint32_t ERTC_Month, uint32_t ERTC_Date)
{
	 /* Set Date Week/Date/Month/Year */
  ERTC_DateStructure.ERTC_WeekDay = 5;
  ERTC_DateStructure.ERTC_Date  = DATAHEXtoBCD(ERTC_Date);
  ERTC_DateStructure.ERTC_Month = DATAHEXtoBCD(ERTC_Month);
  ERTC_DateStructure.ERTC_Year  = DATAHEXtoBCD(ERTC_Year - 2000);
  ERTC_SetDateValue(ERTC_Format_BCD, &ERTC_DateStructure);
...
void set_time(uint32_t ERTC_Hours,uint32_t ERTC_Minutes, uint32_t ERTC_Seconds)
{
	  /* Set Time hh:mm:ss */
  ERTC_TimeStructure.ERTC_AMPM     = ERTC_H12_AM;
  ERTC_TimeStructure.ERTC_Hours   = DATAHEXtoBCD(ERTC_Hours);  
  ERTC_TimeStructure.ERTC_Minutes = DATAHEXtoBCD(ERTC_Minutes);
  ERTC_TimeStructure.ERTC_Seconds = DATAHEXtoBCD(ERTC_Seconds);
  ERTC_SetTimeValue(ERTC_Format_BCD, &ERTC_TimeStructure);
